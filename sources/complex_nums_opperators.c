...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   complex_nums_opperators.c                          :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: mgama <mgama@student.42.fr>                +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/11/27 23:11:20 by mgama             #+#    #+#             */
/*   Updated: 2022/11/27 23:38:03 by mgama            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_complex_number	complex_div(t_complex_number a, t_complex_number b)
{
	...
	if (fabs(b.x) < fabs(b.y))
	{
        x = b.x / b.y;
        t = b.x * x + b.y;
        return (create_complex_number((a.x * x + a.y) / t, (a.y * x - a.x) / t));
    }
	else
	{
		x = b.y / b.x;
        t = b.y * x + b.x;
        return (create_complex_number((a.x + a.y * x) / t, (a.y - a.x * x) / t));
    }
}
